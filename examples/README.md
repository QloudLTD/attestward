...
attestward scan --org Qloud-LTD --repo demo-good --out examples/demo-org-pack/
attestward report examples/demo-org-pack/evidence.json --format html
```
