...
| D1 | Final product name | **Attestward.** Repo, Go module path, and CLI binary all renamed to match (`sioakim/attestward`, private per D7); domain `attestward.com` registered. Trademark clearance search still needed before public launch. | Issue #33, `sioakim/ssdf-website`'s `CLAUDE.md` |
