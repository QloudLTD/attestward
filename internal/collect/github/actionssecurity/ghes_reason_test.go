...
// added after review found this test alone left every call site's actual
...
// GatedRepoReason(false, "", ...) must fail this test; it did not fail any
// other test in this package before this test existed.
